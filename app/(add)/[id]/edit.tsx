      ...
      <ScrollView className={`flex-1 px-4 `}>
       ...
       <Pressable onPress={pickImageAsync}>
        ...
        <View className="flex flex-col   items-center  justify-center bg-white/15 rounded-xl border-white/10 border">
         ...
         <NativeDropDown items={bookFormats} onSelect={(format) => form.setValue('format',format,{shouldDirty: true, shouldTouch: true,shouldValidate: true})} type='edit' />
        ...
        <View className="form-select-container">
         <Text className= {`form-label ${form.formState.errors.readingStatus ? 'text-red-500' : 'text-white/40'}`}>Reading Status</Text>
          <NativeDropDown items={readingStatus} onSelect={(readingStatus) => form.setValue('readingStatus',readingStatus,{shouldDirty: true, shouldTouch: true,shouldValidate: true})} type='edit' />
        </View>
        </View>
        ...
        <View className="form-select-container">
         ...
         <NativeDropDown items={ ownershipStatus}   onSelect={(ownershipStatus) => form.setValue('ownershipStatus',ownershipStatus,{shouldDirty: true, shouldTouch: true,shouldValidate: true})} type='edit' />
        </View>
        </View>
